...
let age = 18;
const college = "Regional college of management";
const course = "Bachelor of Computer Applications (BCA)";
...
document.write("Is Student: " + isStudent + "<br><br>");
...
let databaseMarks = 80;
let gitMarks = 87;

const totalMarks = htmlMarks + cssMarks + javascriptMarks + databaseMarks + gitMarks;
